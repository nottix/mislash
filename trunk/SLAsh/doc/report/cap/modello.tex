...
\end{equation}
Il valore $index$ calcolato rappresenta una percentuale che va da 0 a 100 che indica l'utilizzazione del nodo valutato. L'indice è il fulcro dell'algoritmo di \var{Migration checking}, in quanto la migrazione si basa proprio sul confronto di tale valore.